...
st.markdown(f"<h1 style='text-align: left; color: #RRGGBB ; width:1360px;height : 100px '>Demographic Distribution of CMS Beneficiary Data</h1>",unsafe_allow_html=True)

...
st.markdown(f"<h1 style='text-align: left; color: #35BAE2 ; width:1360px;height : 100px '>Demographic Distribution of CMS Beneficiary Data</h1>",unsafe_allow_html=True)
